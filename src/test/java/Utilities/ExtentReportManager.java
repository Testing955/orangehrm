...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter = new ExtentSparkReporter("/Users/hestabit/eclipse-workspace/OranageHrm/Reports/" + repName);// specify location of the report
sparkReporter.config().setDocumentTitle("OrangeHrm Report"); // Title of report
	...
	public void onFinish(ITestContext testContext) {
		...
		String pathOfExtentReport = "/Users/hestabit/eclipse-workspace/OranageHrm/Reports/"+repName;
